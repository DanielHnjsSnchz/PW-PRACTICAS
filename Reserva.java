...
public abstract class Reserva {
	...
	private String idReservaUsuario;
    Date fecha = new Date();
	private int duracion;
	private String idReservaPista;
	private float precio;
	private float descuento;	//Debe ser guardado en decimales 10%-->0.1
	...
	public String toString() {
		String infoReserva = "ID reserva: " + this.idReservaPista + "\tFecha: " + this.fecha + "\tDuracion: " + this.duracion + "\tPista: " + this.idReservaPista + "\tPrecio: " + precioFinal();
		return infoReserva;
	}
}