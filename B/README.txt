...
Para el correcto uso del programa se debe tener en cuenta el fichero .properties de configuración en el cual se introducen las parejas claves-valor del programa:
...
"reservas.txt"como fichero para guardar la información de las reservas registradas en el sistema.
